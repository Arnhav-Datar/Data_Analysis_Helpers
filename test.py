...
pl.plot_single(
    ...
    save=True,
    height=7,
    filename="penguin_bill_length_vs_depth",
)
pl.plot_all(save=True, height=7, filename="penguin_all")
pl.plot_heatmap_correlations(save=True, filename="penguin_heatmap_correlations")
...
# fs.elastic_net_regression(l1_ratio=0.5)
# fs.lightgbm()
